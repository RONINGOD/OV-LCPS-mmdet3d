...
class _PFCHeadQueryPointsDisLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_lo:
            self.object_distillation_loss = CosineSimilarity()
        
        if self.use_lv:
            self.voxel_distillation_loss = L1Loss()
    ...
    def bipartite_matching(self, class_preds, mask_preds, pos_mask_preds, batch_data_samples,text_features,voxel_vision_clip):
