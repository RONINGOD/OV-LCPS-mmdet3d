...
custom_imports = dict(
    imports=[
        ...
        'p3former.backbones.vision_lidar',
...
# python -m torch.distributed.launch --node_rank=0 --nproc_per_node=2 --master_port=29503 ./train.py configs/pfc/pfc_nuscenes_qa_fusion_lv.py --launcher pytorch