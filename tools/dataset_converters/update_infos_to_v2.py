...
def update_nuscenes_infos(pkl_path, out_dir,data_root):
    ...
    nusc = NuScenes(
        ...
        dataroot=data_root, # './data/nuscenes'
        verbose=True)
...
def update_pkl_infos(dataset, out_dir, pkl_path,data_root):
    if dataset.lower() == 'kitti':
        ...
        update_nuscenes_infos(pkl_path=pkl_path, out_dir=out_dir,data_root=data_root)
