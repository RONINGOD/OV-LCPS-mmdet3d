...
def nuscenes_data_prep(root_path,
    ...
    nuscenes_converter.create_nuscenes_infos(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps,out_path=out_dir)
    ...
    update_pkl_infos('nuscenes', out_dir=out_dir, pkl_path=info_train_path,data_root=root_path)
    update_pkl_infos('nuscenes', out_dir=out_dir, pkl_path=info_val_path,data_root=root_path)
